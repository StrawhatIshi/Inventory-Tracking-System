...
class App {
	...
	private $controller = 'SysFinalProject\controllers\MemberController';
	...
	public function __construct() {
		...
		if (isset($url[0])) {
			if (file_exists('SysFinalProject/controllers/' . $url[0] . '.php')) {
				$this->controller = '\\SysFinalProject\\controllers\\' . $url[0];
			}
