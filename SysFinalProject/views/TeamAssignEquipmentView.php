        ...
        <center>
            ...
            <form action='' method='post'>
                <table>
                    ...
                    <tr style="height: 30px;">
                        <td>Employee ID:</td>
                        <td><input type='text' class="form-control" name='employeeId'></td>
                    </tr> 
                    <tr style="height: 40px;">
                        <td colspan='2' style="text-align:right;"><input type='submit' name='assignB' class="btn btn-outline-primary" value='Assign'></td>
                    </tr> 
                </table>
            </form>
        </center>
